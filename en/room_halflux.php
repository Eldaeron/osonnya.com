...
$PAGE_TITLE = 'Півлюкс - Готель - «Осоння» Карпати'; // Титул сайта
$PAGE_URL = 'room_halflux.php'; // УРЛ-сайта
...
<!-- SUB BANNER --><section class="section-sub-banner bg-9"><div class="awe-overlay"></div>
        ...
        <!-- ROOM DETAIL --><section class="section-room-detail bg-white"><div class="container">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="room-detail_img">
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/1.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/2.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/3.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/4.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/5.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/6.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/7.jpg" alt="">
                                </div>
                            ...
                            <div class="room-detail_thumbs">
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/1min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/2min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/3min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/4min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/5min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/6min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(501,502,503,504)/7min.jpg" alt=""></a>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="room-detail_book">
                                ...
                                <div class="room-detail_total">
                                    ...
                                    <p class="price">
                                        <span class="amout">600₴</span>  /за добу
                                    </p>
                                </div>
                                ...
                                <div class="tab-pane fade" id="amenities">
                                    ...
                                    <div class="room-detail_amenities">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-lg-4">
                                                <h6>Літня тераса зі столиком та гамаком</h6>
...
<td>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">600 грн.</span></p>
                                                </td>
                                                <td>
                                                    <p class="price"><span class="amout">800 грн.</span></p>
                                                </td>
                                                <td>
...
<li>01.06-28.08.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">700 грн.</span></p>
                                                </td>
                                                <td>
                                                    <p class="price"><span class="amout">900 грн.</span></p>
                                                </td>
                                                <td>
...
<li>30.12.16-15.01.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">1000 грн.</span></p>
                                                </td>
                                                <td>
                                                    <p class="price"><span class="amout">1250 грн.</span></p>
                                                </td>
                                                <td>
