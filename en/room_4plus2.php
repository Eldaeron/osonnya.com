...
$PAGE_TITLE = 'Будинок 4+2 - Готель - «Осоння» Карпати'; // Титул сайта
$PAGE_URL = 'room4plus2.php'; // УРЛ-сайта
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="room-detail_img">
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/1.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/2.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/3.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/4.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/5.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/6.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/7.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/8.jpg" alt="">
                                </div>
                            ...
                            <div class="room-detail_thumbs">
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/1min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/2min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/3min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/4min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/5min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/6min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/7min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/4+2(601)/8min.jpg" alt=""></a>
                            </div>
                            <!-- END / THUMBNAIL IMAGE -->
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="room-detail_book">
                                ...
                                <div class="room-detail_total">
                                    ...
                                    <p class="price">
                                        <span class="amout">1850₴</span>  /за добу
                                    </p>
                                </div>
                            ...
                            <div class="room-detail_tab-content tab-content">
                                ...
                                <div class="tab-pane fade active in" id="overview">
                                    ...
                                    <div class="room-detail_overview">
                                        ...
                                        ">Будинок «Над банькою»  4 + 2 (601)</h5>
                                ...
                                <div class="tab-pane fade" id="amenities">
                                    ...
                                    <div class="room-detail_amenities">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-lg-4">
                                                <h6>Зона відпочинку під стріхою</h6>
...
<td>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">1850 грн.</span></p>
                                                </td>
                                                <td>
...
<li>01.06-28.08.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">1900 грн.</span></p>
                                                </td>
                                                <td>
...
<li>30.12.16-15.01.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">2700 грн.</span></p>
                                                </td>
                                                <td>
