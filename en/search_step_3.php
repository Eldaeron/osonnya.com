...
$name = $_POST['name']; 
$phone = $_POST['phone'];
$subject = 'Замовлення через головну сторінку - Osonnya.com';
...
if(mail($to, $subject, $msg, $headers)){
    echo '<p class="reservation-confirm">Дякуємо Вам за запит на бронювання. Ми перевіряємо наявність і ми зв’яжемося з вами як можна швидше.</p>';
}else{
    echo '<p>Сталася помилка під час надсилання листа. Спробуйте пізніше.</p>';
}
?>