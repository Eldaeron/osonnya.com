...
$PAGE_TITLE = 'Стандарт покращенний - Готель - «Осоння» Карпати'; // Титул сайта
$PAGE_URL = 'room_standart_better.php'; // УРЛ-сайта
                        ...
                        <div class="col-lg-9">
                           ...
                           <div class="room-detail_img">
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/1.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/2.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/3.jpg" alt="">
                                </div>
                               
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/5.jpg" alt="">
                                </div>
                            ...
                            <div class="room-detail_thumbs">
                                 <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/1min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/2min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/3min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/(802,803)/5min.jpg" alt=""></a>
                            </div>
                            <!-- END / THUMBNAIL IMAGE -->
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="room-detail_book">
                                ...
                                <div class="room-detail_total">
                                    ...
                                    <p class="price">
                                        <span class="amout">550₴</span>  /за добу
                                    </p>
                                </div>
                            ...
                            <div class="room-detail_tab-content tab-content">
                                ...
                                <div class="tab-pane fade active in" id="overview">
                                    ...
                                    <div class="room-detail_overview">
                                        ...
                                        ">Стандарт покращений ( 801, 804 )</h5>
                              ...
                              <!-- AMENITIES -->
                                <div class="tab-pane fade" id="amenities">
                                    ...
                                    <div class="room-detail_amenities">
                                        <p>Комфортні й по-домашньому затишні номери оснащені всім необхідним для приємного відпочинку.</p>
                                        
                                        <div class="row">
                                            <div class="col-xs-6 col-lg-4">
                                                <h6>Кімната - студія</h6>
                                                <ul>
                                                    <li>Два одномісних ліжка</li>
                                                    <li>Прихожа</li>
...
<p>Балкон зі столиком та гамаком</p>
                                    </div>
...
<td>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">550 грн.</span></p>
                                                </td>
                                                <td>
...
<li>01.06-28.08.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">650 грн.</span></p>
                                                </td>
                                                <td>
...
<li>30.12.16-15.01.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">1150 грн.</span></p>
                                                </td>
                                                <td>
