...
$PAGE_TITLE = 'Будинок 5+2 - Готель - «Осоння» Карпати'; // Титул сайта
$PAGE_URL = 'room_5plus2.php'; // УРЛ-сайта
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="room-detail_img">
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/1.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/2.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/3.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/4.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/5.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/6.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/7.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/8.jpg" alt="">
                                </div>
                            ...
                            <div class="room-detail_thumbs">
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/1min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/2min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/3min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/4min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/5min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/6min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/7min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/5+2(701)/8min.jpg" alt=""></a>
                            </div>
                            <!-- END / THUMBNAIL IMAGE -->
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="room-detail_book">
                                ...
                                <div class="room-detail_total">
                                    ...
                                    <p class="price">
                                        <span class="amout">2500₴</span>  /за добу
                                    </p>
                                </div>
...
<li>Сніданок</li>
                                ...
                                <div class="tab-pane fade" id="amenities">
                                    ...
                                    <div class="room-detail_amenities">
                                        <p>Дво-поверховий котедж оснащений всім необхідним для комфортного та приємного відпочинку.</p>
                                        
                                        <div class="row">
                                            <div class="col-xs-6 col-lg-4">
                                                <h6>Гостьова кімната</h6>
                                                <ul>
                                                    <li>Міні-кухня</li>
                                                    <li>Чайник</li>
                                            ...
                                            <div class="col-xs-6 col-lg-4">
                                                <h6>Дві спальні</h6>
                                                <ul>
                                                    <li>Перша спальня з двома односпальними ліжками</li>
                                                    <li>Друга спальня з трьома односпальними ліжками</li>
                                                    <li>Шафа</li>
                                            ...
                                            <br></br>
                                            <br></br>
                                                <h6>Літня тераса зі столиком та двома гамаками</h6>
...
<td>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">* грн.</span></p>
                                                </td>
                                                <td>
                                                    <p class="price"><span class="amout">2500 грн.</span></p>
                                                </td>
                                                <td>
...
<li>01.06-28.08.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">2800 грн.</span></p>
                                                </td>
                                                <td>
...
<li>30.12.16-15.01.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">4000 грн.</span></p>
                                                </td>
                                                <td>
