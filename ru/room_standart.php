...
$PAGE_TITLE = 'Стандарт - Готель - «Осоння» Карпати'; // Титул сайта
$PAGE_URL = 'room_standart.php'; // УРЛ-сайта
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="room-detail_book">
                                ...
                                <div class="room-detail_total">
                                    ...
                                    <p class="price">
                                        <span class="amout">500₴</span>  /за добу
                                    </p>
                                </div>
...
<td>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">500 грн.</span></p>
                                                </td>
                                                <td>
...
<li>01.06-28.08.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">750 грн.</span></p>
                                                </td>
                                                <td>
...
<li>30.12.16-15.01.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">850 грн.</span></p>
                                                </td>
                                                <td>
                                                    <p class="price"><span class="amout">1050 грн.</span></p>
                                                </td>
                                                <td>
