                            ...
                            <div class="guest-book_mansory">
                                ...
                                <div class="item-masonry col-xs-6 col-md-4">
                                    <div class="guest-book_item guest-book_item-2">
                                        ...
                                        <div class="avatar">
                                            <img src="<?php echo SITE_URL; ?>images/avatar/cl.jpg" alt="">
</div>
                            ...
                            <div class="gallery-isotope col-4">
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/1.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/1min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/2.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/2min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/3.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/3min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/4.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/4min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/5.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/5min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/6.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/6min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/7.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/7min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/8.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/8min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/9.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/9min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/10.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/10min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/11.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/11min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/12.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/12min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/13.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/13min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/14.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/14min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/15.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/15min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/16.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/16min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/17.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/17min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/18.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/18min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/19.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/19min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/20.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/20min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/21.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/21min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
                                ...
                                <div class="item-isotope suite dining">
                                    <div class="gallery_item">
                                        <a href="<?php echo SITE_URL; ?>images/gallery/vidguk/22.jpg" class="mfp-image" title="">
                                            <img src="<?php echo SITE_URL; ?>images/gallery/vidguk/22min.jpg" alt=""></a>
                                        <h6 class="text"></h6>
                                    </div>
                                </div>
                                <!-- END / ITEM -->
