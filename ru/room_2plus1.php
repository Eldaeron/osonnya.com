...
$PAGE_TITLE = 'Будинок 2+1 - Готель - «Осоння» Карпати'; // Титул сайта
$PAGE_URL = 'room_2plus1.php'; // УРЛ-сайта
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="room-detail_img">
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/1.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/2.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/3.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/4.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/5.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/6.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/7.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/8.jpg" alt="">
                                </div>
                            ...
                            <div class="room-detail_thumbs">
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/1min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/2min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/3min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/4min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/5min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/6min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/7min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+1(201,301)/8min.jpg" alt=""></a>
                            </div>
                            <!-- END / THUMBNAIL IMAGE -->
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="room-detail_book">
                                ...
                                <div class="room-detail_total">
                                    ...
                                    <p class="price">
                                        <span class="amout">950₴</span>  /за добу
                                    </p>
                                </div>
...
<td>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">950 грн.</span></p>
                                                </td>
                                                <td>
...
<li>30.12.16-15.01.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">1550 грн.</span></p>
                                                </td>
                                                <td>
