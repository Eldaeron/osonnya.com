...
$PAGE_TITLE = 'Будинок 2+3 - Готель - «Осоння» Карпати'; // Титул сайта
$PAGE_URL = 'room2plus3.php'; // УРЛ-сайта
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="room-detail_img">
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/1.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/2.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/3.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/4.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/5.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/6.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/7.jpg" alt="">
                                </div>
                                <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/8.jpg" alt="">
                                </div>
                                 <div class="room_img-item">
                                    <img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/9.jpg" alt="">
                                </div>
                            </div>
                            <!-- END / LAGER IMGAE -->
                            ...
                            <div class="room-detail_thumbs">
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/1min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/2min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/3min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/4min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/5min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/6min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/7min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/8min.jpg" alt=""></a>
                                <a href="#"><img src="<?php echo SITE_URL; ?>images/gallery/2+3(401)/9min.jpg" alt=""></a>
                            </div>
                            <!-- END / THUMBNAIL IMAGE -->
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="room-detail_book">
                                ...
                                <div class="room-detail_total">
                                    ...
                                    <p class="price">
                                        <span class="amout">1300₴</span>  /за добу
                                    </p>
                                </div>
                                ...
                                <div class="tab-pane fade" id="amenities">
                                    ...
                                    <div class="room-detail_amenities">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-lg-4">
                                                <h6>Літня тераса зі столиком</h6>
...
<td>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">1300 грн.</span></p>
                                                </td>
                                                <td>
...
<li>01.06-28.08.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">1400 грн.</span></p>
                                                </td>
                                                <td>
...
<li>30.12.16-15.01.17</li>
                                                ...
                                                <td>
                                                    <p class="price"><span class="amout">2000 грн.</span></p>
                                                </td>
                                                <td>
